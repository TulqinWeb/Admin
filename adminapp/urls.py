...
from .views import home_page, logout_page, login_page, SignUpView, faculty_list, faculty_create, faculty_edit, \
    faculty_delete, kafedra_list, kafedra_create, kafedra_edit, kafedra_delete, subject_list, subject_create, \
    subject_edit, subject_delete, teacher_list, teacher_create, teacher_edit, teacher_delete, group_list, group_create, \
    group_edit, group_delete, student_list, student_create, student_edit, student_delete
